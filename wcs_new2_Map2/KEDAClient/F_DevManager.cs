...
namespace KEDAClient
{
    ...
    {
        public static F_DevManager F_Dev;
        public static void Init()
        {
            F_Dev = new F_DevManager();
        }
    }
    ...
    public class F_DevManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DeviceBackImf FindDevInHeadPlc()
        {
            lock (_ans)
            {
                return _devList.Find(c => { return c.IGet("0002").RValue.Equals("14")&&c.IGet("00036").RValue.Equals("3"); });
            }
        }
