...
namespace KEDAClient
{
    ...
    public partial class KEDAForm : Form
    {
        ...
        GfxList<GfxServiceContractTaskExcute.TaskBackImf> tasksList;// = JtWcfTaskHelper.GetAllTask();
        ...
        private void charge_Click(object sender, EventArgs e)
        {
            ...
            else //if (Convert.ToInt32(vehicleslist.FocusedItem.SubItems[4].Text) < 100)
            {
                ...
                if (JtWcfTaskHelper.StartTaskTemp("客户端_KEDA", task))
                {
                    //记录agv状态
        ...
        private void queryDataThreadFunc()
        {
            while (true)
            {
                if (!JtWcfTaskHelper.IsConnected || !JtWcfDispatchHelper.Open())
                {
                    Thread.Sleep(1000);
                    continue;
                }
                else
                {
                    ...
                    switch (tabControl1SelectIndex)
                    {
                        case 0://0 task
                            ...
                            break;
                        case 1://1 alarms
                            devsList = JtWcfMainHelper.GetDevList();
                            devOk = true;
                            break;
                        case 2://2 logger
