...
namespace JTWcfHelper
{
    ...
    public class JtWcfMainHelper
    {
        ...
        /// <summary>
        /// 获取任务状态
        /// </summary> Unknow = 0,Err = 1, UnReady = 2, Wait = 3,Fail = 4, Doing = 5,Suc = 6, Cancl = 7
        ...
        /// 控制调度状态
        /// </summary>
        /// <param name="DisOrderCtrTypeEnum oper">控制参数</param>
        /// 控制参数：start、pause、stop
        /// true ：控制成功
        /// false ：对象为空
        ...
        public static bool StartDispatch(DispatchOrderObj order, out string msg)
        {
            ...
            return msg == "s" ? true : false;  // 开始一个新的调度，s为调度成功， other 为执行结果
        }

        /// <summary>
        /// 设置设备紧急状态
        /// </summary>
        /// <param name="dev   设备id"></param>
    ...
    public class BackupClass : IServerCtrBack
    {
        ...
        public void UpdateDevStatue(GfxList<DeviceBackImf> devObjs)
        {
            try
            {
                ...
                if (JtWcfMainHelper.GetNewMsgEvent != null)
                {
                    JtWcfMainHelper.GetNewMsgEvent(null, new DevStatueEventArgs(devObjs));
                }
            }
            catch { }
        }
        ...
        public void MemberListUpdate(MemberChangeBackImf member)
        {
            try
            {
                ...
                if (JtWcfMainHelper.DevPtyChangeEvent != null)
                {
                    JtWcfMainHelper.DevPtyChangeEvent(null, new DevPtyEventArgs(temp, member.OperType));
                }
            }
            catch { }
        }
